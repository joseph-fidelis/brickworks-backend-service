...
# Admin Dashboard Rendered Views 
...
def parts_page(request):
    """Render the upload XML page."""
    return render(request, "dashboard/parts.html")

@login_required(login_url='login')
def minifigure_page(request):
    """Render the upload XML page."""
    return render(request, "dashboard/minifigure.html")

@login_required(login_url='login')
def gears_page(request):
    """Render the upload XML page."""
    return render(request, "dashboard/gears.html")

@login_required(login_url='login')
def parts_with_colors_page(request):
    """Render the upload XML page."""
    return render(request, "dashboard/parts_with_colors.html")
